...
PS1='\[\e[92;1m\]\u@\H\[\e[0m\]:\[\e[94;1m\]\w\[\e[91m\]${PS1_BRANCH}\[\e[0m\]\\$ '


#    M A R K S 
marks(){
	cat $HOME/coding/hs/marks-hs/reports/$1.txt | $HOME/coding/hs/marks-hs/main
}
...
vmarks(){
	vim $HOME/coding/hs/marks-hs/reports/$1.txt
}

#    B A C K  G R O U N D
alias b="$SCRIPTS_DIR/background/bg.sh"
alias ab="$SCRIPTS_DIR/background/abg.sh"


#    B L U E T O O T H
alias bton="rfkill unblock bluetooth"
alias btoff="rfkill block bluetooth"
alias bluetui=/opt/bluetui/bin
. "/home/robda20188/.deno/env"
